...
function preload() {
    ...
    let mango = {
        whole: loadImage("assets/mango.png"),
...
function splitFruit(x, y, fruitData) {
    ...
    left.colider = "" // dynamic - affected by gravity and has colision/ static, not affected
    left.overlaps(allSprites);  // disable colisions
    left.layer = 1
